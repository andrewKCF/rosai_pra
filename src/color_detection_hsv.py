...
from rosai_pra.cfg import HSVColorDetectionConfig
...
class ColorDetectionDemo():
    ...
    def __init__(self):
        ...
        # 设置参数
        self.H_min = rospy.get_param("~H_min", 95)
        self.H_max = rospy.get_param("~H_max", 117)
        self.S_min = rospy.get_param("~S_min", 70)
        self.S_max = rospy.get_param("~S_max", 149)
        self.V_min = rospy.get_param("~V_min", 93)
        self.V_max = rospy.get_param("~V_max", 122)
        # 创建动态配置服务器对象
